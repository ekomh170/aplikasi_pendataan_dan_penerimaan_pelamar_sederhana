...
if ($_POST['submit']) {
	...
	//foto
			...
			$data = mysqli_query($koneksi,"UPDATE tb_pelamar SET id_pelamar ='$id_pelamar', nama_lengkap = '$nama_lengkap', alamat = '$alamat', tmpt_lahir = '$tmpt_lahir', tanggal_lahir = '$tanggal_lahir', jenis_kelamin = '$jenis_kelamin', tamat_sekolah = '$tamat_sekolah',  jurusan = '$jurusan', ft_ktp = '$ft_ktp', skck = '$skck', ijazah = '$ijazah', ft_transkip = '$ft_transkip', no_telp = '$no_telp' WHERE id_pelamar ='$id_pelamar'") or die(mysqli_error($koneksi));
