...
<div class="row">
  <div class="col-md-12">
    <h1 class="page-header">
      Halaman <small>Utama</small>
    </h1>
    <div class="panel panel-default" style="background-color: aqua;">
      <div class="panel-body">
        <img src="<?= base_url();?>assets/foto/logo.jpg" style="margin-top: 30px; margin-left: 400px; border-radius: 50%;"><br><br>
        <img src="<?= base_url();?>assets/foto/bg-2.jpg" style="margin: auto; margin-left: 200px;"><br><br>
        <div class="panel panel-default" style="background-color: skyblue;">
          <h1 style="text-align: center;">PT Argha Karya Prima Industry Tbk</h1><br>
          <div class="" style="font-size: 25px;">SEKILAS PT ARGHA
            ...
            Sesuai dengan Anggaran Dasar, kegiatan usaha Perseroan antara lain bergerak dalam bidang perindustrian dan pemasaran barang-barang dari plastik dan menjalankan industri barang-barang dari plastik, termasuk jenis film Polypropylene dan Polyethylene Terepthalate.
